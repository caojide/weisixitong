...
<script>
import commentPage from './interactivePage/commentPage' 	
import introduction from './interactivePage/introduction' 	
import qrCode from './interactivePage/qrCode' 	
export default {
	name:"interactive",
	data(){
		return{
